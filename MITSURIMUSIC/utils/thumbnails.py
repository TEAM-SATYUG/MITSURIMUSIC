...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("MITSURIMUSIC/assets/thumb/font2.ttf", 32)
        regular_font = ImageFont.truetype("MITSURIMUSIC/assets/thumb/font.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "MITSURIMUSIC/assets/thumb/play_icons.png"
